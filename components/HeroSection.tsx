...
const style = {
  ...
  contentWrapper: `flex flex-col lg:flex-row h-screen relative justify-center lg:justify-evenly items-center space-x-4 `,
  copyContainer: `px-20 lg:w-[45rem] lg:px-0 space-y-6 mb-10  flex flex-col items-center lg:items-start `,
  ...
  ctaContainer: `flex`,
  accentedButton: ` relative text-lg font-semibold px-12 py-4  rounded-lg mr-5 bg-indigo-500 text-indigo-200 hover:bg-indigo-300 hover:text-indigo-500 transition duration-300 ease-in cursor-pointer`,
          ...
          <div className={style.cardContainer}>
            <div className="overflow-hidden rounded-xl">
              <div className="rounded-xl bg-gradient-to-br from-violet-800 to-indigo-400 transition duration-300 ease-in-out hover:scale-150 hover:rounded-2xl ">
                <img
                  className="w-80 h-96 rounded-xl object-cover p-2 lg:h-96 lg:w-80 "
