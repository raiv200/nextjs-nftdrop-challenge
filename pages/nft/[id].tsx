...
function NFTDropPage({ collection }: Props) {
    ...
    return (
        ...
        <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
            ...
            <div className="flex flex-1 flex-col p-12 lg:col-span-6 bg-gradient-to-br from-indigo-200 to-violet-700 ">
                {/* Header  */}

                <header className=" flex items-center justify-between ">
                    <Link href="/">

                        <h1 className="w-52 text-gray-100  font-semibold cursor-pointer text-md lg:text-xl  sm:w-80  ">
                            {' '}
                            <span className="font-extrabold text-lg lg:text-xl text-indigo-500  decoration-indigo-200">
                                CRYPTO APE
                            </span>
                            {'  '}
                            NFT Market Place
                ...
                {address && (
                    <p className="text-center font-normal text-sm lg:text-lg my-4 text-indigo-100 "> You are Logged In with Wallet
                        {'  '}
                ...
                <div className="mt-10 lg:mt-1 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0  ">
                    <div className="  overflow-hidden rounded-2xl mb-6 ring-8 ring-indigo-300 ">
                    ...
                    <h1 className="text-3xl text-indigo-100 font-bold lg:text-4xl lg:font-extrabold ">
                        {collection?.title}
                    </h1>

                    {loading ? (
                        <p className="pt-2 lg:pt-6 text-xl text-amber-500  ">
                            <svg className="animate-spin -ml-1 mr-3 h-8 w-8 text-indigo-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        <p className="pt-2 lg:pt-6 text-xl text-indigo-200 mt-4 ">{claimedSupply}/{totalSupply?.toString()} NFT's claimed</p>
